...
CLASS ZCL_ZOV_MPC IMPLEMENTATION.
...
lo_action->bind_input_structure( iv_structure_name  = 'ZCL_ZOV_MPC=>TS_ZFI_ATUALIZA_STATUS' ). "#EC NOTEXT
  endmethod.
...
lo_property->set_nullable( abap_false ).
lo_property->set_filterable( abap_false ).
lo_complex_type->bind_structure( iv_structure_name = 'ZCL_ZOV_MPC=>MENSAGEM2' ). "#EC NOTEXT
  endmethod.
...
lo_entity_type->bind_structure( iv_structure_name  = 'ZCL_ZOV_MPC=>TS_MENSAGEM' ). "#EC NOTEXT
...
lo_entity_type->bind_structure( iv_structure_name  = 'ZCL_ZOV_MPC=>TS_OVCAB' ). "#EC NOTEXT
...
lo_entity_type->bind_structure( iv_structure_name  = 'ZCL_ZOV_MPC=>TS_OVITEM' ). "#EC NOTEXT
...
*&---------------------------------------------------------------------*
  ...
  CONSTANTS: lc_gen_date_time TYPE timestamp VALUE '20240607204301'.                  "#EC NOTEXT
